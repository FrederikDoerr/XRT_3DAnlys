...
addpath('H:\Matlab_Files\FileExchange\Zernike_code\Zernike_code')
dir_name = 'H:\Matlab_Files\FileExchange\Zernike_code\Zernike_code';
...
%--------------------------------------------------------------------------
% row 1
p = rgb2gray(imread(fullfile(dir_name,'Oval_H.png')));
figure;subplot(2,3,1);imshow(p);
...
p = rgb2gray(imread(fullfile(dir_name,'Oval_45.png')));
...
p = rgb2gray(imread(fullfile(dir_name,'Oval_V.png')));
p = imresize(p, 'Scale',2);p = p(50:450,50:450);
...
%--------------------------------------------------------------------------
% row 2
p = rgb2gray(imread(fullfile(dir_name,'shape_0.png')));
...
p = rgb2gray(imread(fullfile(dir_name,'shape_90.png')));
...
p = rgb2gray(imread(fullfile(dir_name,'Rectangular_H.png')));
